...
namespace CaCuSibAutoPlan.Modules.DvhEstimation
{
    public sealed class DvhEstimationModule
    {
        ...
        public void Run(ScriptContext context, AutoPlanSettings settings)
        {
            ...
            try
            {
                ...
                double? ptv1DoseGy = ParseNullableDose(ui.Ptv1DoseGyText);
                string ptv1ModelId = "PTV_50Gy";

                string ptv2Id = ui.Ptv2Id;
                double? ptv2DoseGy = ParseNullableDose(ui.Ptv2DoseGyText);
                string ptv2ModelId = "PTV_50Gy";

                string ptv3Id = ui.Ptv3Id;
                double? ptv3DoseGy = ParseNullableDose(ui.Ptv3DoseGyText);
        ...
        private static double? ParseNullableDose(string value)
        {
