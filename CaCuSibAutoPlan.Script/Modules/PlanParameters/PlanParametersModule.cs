...
namespace CaCuSibAutoPlan.Modules.PlanParameters
{
    public sealed class PlanParametersModule
    {
        ...
        private static PlanCreationOptions BuildOptions(AutoPlanSettings ui)
        {
            ...
            return new PlanCreationOptions
            {
                ...
                SelectedPrescriptionName = !string.IsNullOrWhiteSpace(ui.PrescriptionName)
                    ? ui.PrescriptionName
                    : ui.PrescriptionId,
